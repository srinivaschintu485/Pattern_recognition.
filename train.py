...
if __name__ == "__main__":
    ...
    lr = 1e-4
    num_epochs = 100
    model_path = os.path.join("/home/srinivas/pattern-recognition/RESUNET/files", "model.h5")
    csv_path = os.path.join("/home/srinivas/pattern-recognition/RESUNET/files", "data.csv")
    """ Dataset """
